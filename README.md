...
- **🎤 Presentation:** Selected for an **oral presentation** at ICPR 2024.  

---

## 💼 Current Projects  

- **Bangla NLP Sentence Completion Model**  
  Fine-tuning **BanglaBERT** to improve Bangla sentence structure with auxiliary verbs, conjunctions, and prepositions.  

---

## 🛠️ Skills  
- **Programming:** Python, JavaScript, C++.  
- **Frameworks & Libraries:** TensorFlow, PyTorch, Hugging Face Transformers, LangChain.  
- **Tools:** Git, Docker, VS Code.  
- **Interests:** Few-shot Learning, Astronomical Research, Blockchain Security.
...
## 🖋️ Fun Fact  
I love blending technology with real-world problems to create innovative solutions that make a difference!  
